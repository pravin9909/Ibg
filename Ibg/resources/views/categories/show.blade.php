                        ...
                        <table id="example" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width:100%">
                            ...
                            <tbody>
                                <tr>
                                    <th scope="row">
                                        <div class="form-check">
                                            <input class="form-check-input fs-15" type="checkbox" name="checkAll" value="option{{ $category->id }}">
                                        </div>
                                    </th>
                                    <td>Title:</td>
                                            ...
                                            {{-- <ul class="dropdown-menu dropdown-menu-end">
                                                ...
                                                <li>
                                                    <form action="{{ route('categories.destroy', $category->id) }}" method="POST" style="display: inline;">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit" class="dropdown-item remove-item-btn" onclick="return confirm('Are you sure you want to delete this category?')">
                                ...
                                <tr>
                                    ...
                                    <td>Description:</td>
                                    <td><div>{!! $category->description !!}</div></td>
                                    <td></td>
                                </tr>
