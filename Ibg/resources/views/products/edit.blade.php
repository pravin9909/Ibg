...
<!-- Mirrored from themesbrand.com/velzon/html/corporate/dashboard-analytics.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 11 Aug 2023 17:07:49 GMT -->
<head>
...
{{-- 
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <form action="{{ route('logout') }}" method="post" class="dropdown-item"><i class="mdi mdi-logout text-muted fs-16 align-middle me-1"></i> <span class="align-middle" data-key="t-logout">
                            @csrf
            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        <li class="menu-title"><span data-key="t-menu">IBG Pannel</span></li>
                        <li class="nav-item">
                    ...
                    <div class="col-md-12">
                        ...
                        <form action="{{ route('products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="subtitle" name="subtitle" value="{{ old('subtitle', $product->subtitle) }}">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="specification" name="specification" rows="3">{{ old('specification', $product->specification) }}</textarea>
                            </div>
                            <div class="form-group">
                                <label for="video_link">Video Link</label>
                                <input type="text" class="form-control" id="video_link" name="video_link" value="{{ old('video_link', $product->video_link) }}">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="size_guide" name="size_guide" value="{{ old('size_guide', $product->size_guide) }}">
                            </div>
                            <div class="form-group">
                                <label for="main_image">Main Image</label>
                                <input type="file" class="form-control-file" id="main_image" name="main_image">
                                @if ($product->main_image)
                                    <img src="{{ asset('storage/' . $product->main_image) }}" alt="{{ $product->title }}" class="img-fluid mt-2">
                                @endif
                            </div>
                            <div class="form-group">
...
<!-- Mirrored from themesbrand.com/velzon/html/corporate/dashboard-analytics.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 11 Aug 2023 17:08:58 GMT -->
</html>